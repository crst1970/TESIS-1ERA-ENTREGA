...
Desde `Pipeline_manual/notebooks`, descarga NIfTI preprocesados:
...
Si los archivos estan en `filt_noglobal`, ABIDE PCP ya aplico band-pass. En ese caso usa `--skip-bandpass` o `apply_bandpass=False` para evitar doble filtrado:
